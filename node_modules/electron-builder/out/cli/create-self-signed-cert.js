...
let createSelfSignedCert = exports.createSelfSignedCert = (() => {
    var _ref = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (publisher) {
        ...
        (0, (_electronBuilderUtil || _load_electronBuilderUtil()).log)((0, (_chalk || _load_chalk()).bold)('When asked to enter a password ("Create Private Key Password"), please select "None".'));
        try {
            ...
            (0, (_electronBuilderUtil || _load_electronBuilderUtil()).log)(`${pfx} created. Please see https://github.com/electron-userland/electron-builder/wiki/Code-Signing how to use it to sign.`);
            const certLocation = "Cert:\\LocalMachine\\TrustedPeople";
            (0, (_electronBuilderUtil || _load_electronBuilderUtil()).log)(`${pfx} will be imported into ${certLocation} Operation will be succeed only if runned from root. Otherwise import file manually.`);
