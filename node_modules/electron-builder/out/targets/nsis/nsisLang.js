...
function _load_langs() {
    return _langs = require("../../util/langs");
}
...
class LangConfigurator {
    constructor(options) {
        ...
        if (this.isMultiLang) {
            this.langs = rawList == null ? (_langs || _load_langs()).bundledLanguages.slice() : (0, (_electronBuilderUtil || _load_electronBuilderUtil()).asArray)(rawList).map(it => (0, (_langs || _load_langs()).toLangWithRegion)(it.replace("-", "_")));
        } else {
            this.langs = ["en_US"];
        }
    }
