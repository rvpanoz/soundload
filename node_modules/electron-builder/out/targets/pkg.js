...
class PkgTarget extends (_core || _load_core()).Target {
    ...
    build(appPath, arch) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            packager.dispatchArtifactCreated(outFile, _this, arch, packager.computeSafeArtifactName("pkg", arch));
        })();
    }
    customizeDistributionConfiguration(distInfoFile, appPath) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            yield (0, (_electronBuilderUtil || _load_electronBuilderUtil()).exec)("productbuild", ["--synthesize", "--component", appPath, distInfoFile], {
                cwd: _this2.outDir
            });
    ...
    buildComponentPackage(appPath, outFile) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            (0, (_electronBuilderUtil || _load_electronBuilderUtil()).use)(_this3.options.installLocation || "/Applications", function (it) {
