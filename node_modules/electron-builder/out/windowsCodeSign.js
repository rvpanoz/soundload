...
let spawnSign = (() => {
    var _ref2 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (options, inputPath, outputPath, hash, nest) {
        ...
        return yield (0, (_electronBuilderUtil || _load_electronBuilderUtil()).exec)(toolInfo.path, args, {
            timeout: 120 * 1000,
...
let getToolPath = (() => {
    var _ref3 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
        ...
        if (process.platform === "win32") {
            ...
            let suffix = null;
            try {
                if (yield (0, (_electronBuilderUtil || _load_electronBuilderUtil()).isMacOsSierra)()) {
                ...
                (0, (_electronBuilderUtil || _load_electronBuilderUtil()).warn)(`${e.stack || e}`);
            }
