...
let getElectronVersion = exports.getElectronVersion = (() => {
    var _ref = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (projectDir, config) {
        let projectMetadata = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : new (_lazyVal || _load_lazyVal()).Lazy(function () {
...
let getElectronVersionFromInstalled = exports.getElectronVersionFromInstalled = (() => {
    ...
    return function getElectronVersionFromInstalled(_x4) {
...
let computeElectronVersion = exports.computeElectronVersion = (() => {
    ...
    return function computeElectronVersion(_x5, _x6) {
