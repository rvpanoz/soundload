...
let computeFileSets = exports.computeFileSets = (() => {
    var _ref = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (matchers, transformer, packager, isElectronCompile) {
        ...
        for (const matcher of matchers) {
            ...
            if (fromStat == null) {
                (0, (_electronBuilderUtil || _load_electronBuilderUtil()).debug)(`Directory ${fileWalker.matcher.from} doesn't exists, skip file copying`);
                continue;
            }
...
let compileUsingElectronCompile = (() => {
    var _ref2 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (mainFileSet, packager) {
        (0, (_electronBuilderUtil || _load_electronBuilderUtil()).log)("Compiling using electron-compile");
        const electronCompileCache = yield packager.tempDirManager.getTempDir("electron-compile-cache");
