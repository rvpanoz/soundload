    ...
    var _ref3 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (fileSet, autoUnpackDirs, unpackedDest) {
        ...
        for (let i = 0, n = fileSet.files.length; i < n; i++) {
            ...
            if ((_electronBuilderUtil || _load_electronBuilderUtil()).debug.enabled) {
                (0, (_electronBuilderUtil || _load_electronBuilderUtil()).debug)(`${getRelativePath(fileSet, packageDir)} is not packed into asar archive - contains executable code`);
            }
...
let order = (() => {
    var _ref5 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (filenames, orderingFile, src) {
        ...
        (0, (_electronBuilderUtil || _load_electronBuilderUtil()).log)(`Ordering file has ${(total - missing) / total * 100}% coverage.`);
        return sortedFiles;
    });
