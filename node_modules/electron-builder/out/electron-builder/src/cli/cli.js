...
let rebuildAppNativeCode = (() => {
    var _ref = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (args) {
        ...
        (0, (_electronBuilderUtil || _load_electronBuilderUtil()).log)(`Execute node-gyp rebuild for ${args.platform}:${args.arch}`);
...
function checkIsOutdated() {
    ...
    }).catch(e => (0, (_electronBuilderUtil || _load_electronBuilderUtil()).warn)(`Cannot check updates: ${e}`));
}