...
let installAppDeps = exports.installAppDeps = (() => {
    var _ref = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (args) {
        ...
        const results = yield (_bluebirdLst2 || _load_bluebirdLst2()).default.all([(0, (_config || _load_config()).computeDefaultAppDirectory)(projectDir, (0, (_electronBuilderUtil || _load_electronBuilderUtil()).use)(config.directories, function (it) {
            return it.app;
...
if (process.mainModule === module) {
    (0, (_electronBuilderUtil || _load_electronBuilderUtil()).warn)("Please use as subcommand: electron-builder install-app-deps");
