...
function _load_fs2() {
    return _fs2 = require("../../../../electron-builder-util/src/fs");
}
...
class NsisTarget extends (_core || _load_core()).Target {
    ...
    configureDefines(oneClick, defines) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            defines.SHORTCUT_NAME = (0, (_electronBuilderUtil || _load_electronBuilderUtil()).isEmptyOrSpaces)(options.shortcutName) ? defines.PRODUCT_FILENAME : packager.expandMacro(options.shortcutName);
    ...
    computeFinalScript(originalScript, isInstaller) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            scriptGenerator.addIncludeDir(_path.join((_nsisUtil || _load_nsisUtil()).nsisTemplatesDir, "include"));
            ...
            taskManager.add((0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
                scriptGenerator.addPluginDir(pluginArch, _path.join((yield nsisResourcePathPromise), "plugins", pluginArch));
            }));
            taskManager.add((0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
                const userPluginDir = _path.join(packager.buildResourcesDir, pluginArch);
                const stat = yield (0, (_fs2 || _load_fs2()).statOrNull)(userPluginDir);
            ...
            taskManager.add(function () {
                return (0, (_nsisLicense || _load_nsisLicense()).computeLicensePage)(packager, _this8.options, scriptGenerator);
            });
            const isMultiLang = _this8.isUnicodeEnabled && _this8.options.multiLanguageInstaller !== false;
            taskManager.addTask((0, (_nsisUtil || _load_nsisUtil()).addCustomMessageFileInclude)("messages.yml", packager, isMultiLang, scriptGenerator));
            if (!_this8.isPortable) {
                if (_this8.isUnicodeEnabled && _this8.options.oneClick === false) {
                    taskManager.addTask((0, (_nsisUtil || _load_nsisUtil()).addCustomMessageFileInclude)("assistedMessages.yml", packager, isMultiLang, scriptGenerator));
                }
                taskManager.add((0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
