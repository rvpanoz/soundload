    ...
    computeDesktopIcons() {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            if (resourceList.indexOf("icons") !== -1) {
                ...
                const iconDir = yield packager.getTempDir("linux.iconset");
...
function resizeImage(imagePath, result, w, h) {
    if (process.platform === "darwin") {
        return (0, (_electronBuilderUtil || _load_electronBuilderUtil()).exec)("sips", ["--resampleHeightWidth", h.toString(10), w.toString(10), imagePath, "--out", result]);
    } else {
        const sizeArg = `${w}x${h}`;
        return (0, (_electronBuilderUtil || _load_electronBuilderUtil()).exec)("gm", ["convert", "-size", sizeArg, imagePath, "-resize", sizeArg, result]);
    }
}
