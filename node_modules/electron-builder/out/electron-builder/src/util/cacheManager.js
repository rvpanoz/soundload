...
class BuildCacheManager {
    constructor(outDir, executableFile, arch) {
        ...
        this.cacheDir = _path.join(outDir, ".cache", (_electronBuilderUtil || _load_electronBuilderUtil()).Arch[arch]);
    ...
    copyIfValid(digest) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            if (oldDigest !== digest) {
                (0, (_electronBuilderUtil || _load_electronBuilderUtil()).debug)(`No valid cached executable found, old digest: ${oldDigest}, new digest: ${digest}`);
                return false;
            }
            (0, (_electronBuilderUtil || _load_electronBuilderUtil()).debug)(`Copy cached executable to ${_this.executableFile}`);
            try {
                yield (0, (_fs || _load_fs()).copyFile)(_this.cacheFile, _this.executableFile, false);
                return true;
            } catch (e) {
                if (e.code === "ENOENT" || e.code === "ENOTDIR") {
                    (0, (_electronBuilderUtil || _load_electronBuilderUtil()).debug)(`Copy cached executable failed: ${e.code}`);
                } else {
                    (0, (_electronBuilderUtil || _load_electronBuilderUtil()).warn)(`Cannot copy cached executable: ${e.stack || e}`);
                }
            }
            return false;
        })();
    ...
    save() {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            try {
                ...
                (0, (_electronBuilderUtil || _load_electronBuilderUtil()).warn)(`Cannot save build cache: ${e.stack || e}`);
            }
        })();
    }
}
