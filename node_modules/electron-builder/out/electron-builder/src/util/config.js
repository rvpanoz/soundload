...
let getConfig = exports.getConfig = (() => {
    var _ref = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (projectDir, configPath, configFromOptions) {
        ...
        const configRequest = { packageKey: "build", configFilename: "electron-builder", projectDir, packageMetadata, log: (_electronBuilderUtil || _load_electronBuilderUtil()).log };
        const config = yield (0, (_readConfigFile || _load_readConfigFile()).getConfig)(configRequest, configPath, configFromOptions);
...
let validateConfig = exports.validateConfig = (() => {
    var _ref3 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (config) {
...
let computeDefaultAppDirectory = exports.computeDefaultAppDirectory = (() => {
    var _ref4 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (projectDir, userAppDir) {
        if (userAppDir != null) {
