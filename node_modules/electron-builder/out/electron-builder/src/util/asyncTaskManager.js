...
class AsyncTaskManager {
    ...
    addTask(promise) {
        if (this.cancellationToken.cancelled) {
            (0, (_electronBuilderUtil || _load_electronBuilderUtil()).debug)(`Async task not added because cancelled: ${new Error().stack}`);
        ...
        this.tasks.push(promise.catch(it => {
            (0, (_electronBuilderUtil || _load_electronBuilderUtil()).debug)(`Async task error: ${it.stack || it}`);
            this.errors.push(it);
