...
let _readInstalled = (() => {
    var _ref3 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (dir, obj, parent, name, depth, pathToMetadata) {
        ...
        const childModules = yield readScopedDir(_path.join(dir, "node_modules"));
...
let readChildPackage = (() => {
    var _ref4 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (name, parentDir, parent, parentDepth, pathToMetadata) {
        const rawDir = _path.join(parentDir, "node_modules", name);
        let dir = rawDir;
        ...
        if (isSymbolicLink) {
            ...
            if (dir == null) {
                (0, (_electronBuilderUtil || _load_electronBuilderUtil()).debug)(`Broken symlink ${rawDir}`);
                return null;
            }
        }
    ...
    return function readChildPackage(_x9, _x10, _x11, _x12, _x13) {
        return _ref4.apply(this, arguments);
    };
})();

let readScopedDir = (() => {
    var _ref5 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (dir) {
        let files;
        try {
    ...
    return function readScopedDir(_x14) {
