...
class AppInfo {
    constructor(info, buildVersion) {
        this.info = info;
        this.description = (0, (_electronBuilderUtil || _load_electronBuilderUtil()).smarten)(this.info.metadata.description || "");
    ...
    get id() {
        ...
        if (appId != null && (appId === "your.id" || (0, (_electronBuilderUtil || _load_electronBuilderUtil()).isEmptyOrSpaces)(appId))) {
            ...
            (0, (_electronBuilderUtil || _load_electronBuilderUtil()).warn)(`Do not use "${incorrectAppId}" as appId, "${appId}" will be used instead`);
        }
    ...
    computePackageUrl() {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            const url = _this.info.metadata.homepage;
            if (url != null) {
                return url;
            }
