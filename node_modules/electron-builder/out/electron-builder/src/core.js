...
class Platform {
    ...
    createTarget(type) {
        ...
        if (this === Platform.MAC) {
            archs = [(_electronBuilderUtil || _load_electronBuilderUtil()).Arch.x64];
        }
        for (const arch of archs == null || archs.length === 0 ? [(0, (_electronBuilderUtil || _load_electronBuilderUtil()).archFromString)(process.arch)] : archs) {
