            ...
            try {
                ...
                if (e instanceof (_electronBuilderHttp || _load_electronBuilderHttp()).HttpError && e.response.statusCode === 404) {
                    if (_this.options.publish !== "onTagOrDraft") {
                        (0, (_electronBuilderUtil || _load_electronBuilderUtil()).log)(`Version ${_this.version} doesn't exist, creating one`);
                        return _this.client.createVersion(_this.version);
                    } else {
                        (0, (_electronBuilderUtil || _load_electronBuilderUtil()).log)(`Version ${_this.version} doesn't exist, artifacts will be not published`);
                    }
                }
                throw e;
            }
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            const options = {
                ...
                headers: {
                    ...
                    "X-Bintray-Publish": "1",
                    "X-Bintray-Debian-Architecture": (0, (_electronBuilderUtil || _load_electronBuilderUtil()).toLinuxArchString)(arch)
                }
            };
            ...
            for (let i = 0; i < 3; i++) {
                try {
                    return yield (_nodeHttpExecutor || _load_nodeHttpExecutor()).httpExecutor.doApiRequest((0, (_electronBuilderHttp || _load_electronBuilderHttp()).configureRequestOptions)(options, _this2.client.auth), _this2.context.cancellationToken, requestProcessor);
                } catch (e) {
                    if (attemptNumber++ < 3 && (e instanceof (_electronBuilderHttp || _load_electronBuilderHttp()).HttpError && e.response.statusCode === 502 || e.code === "EPIPE")) {
                        continue;
                    }
                    throw e;
                }
