...
class GitHubPublisher extends (_publisher || _load_publisher()).HttpPublisher {
    ...
    githubRequest(path, token) {
        ...
        return (0, (_electronBuilderHttp || _load_electronBuilderHttp()).parseJson)((_nodeHttpExecutor || _load_nodeHttpExecutor()).httpExecutor.request((0, (_electronBuilderHttp || _load_electronBuilderHttp()).configureRequestOptions)({
